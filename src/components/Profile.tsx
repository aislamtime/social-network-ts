...
export function Profile() {
  return (
    <div className="profile">
      <div className="profile__cover"><img src="" alt="" /></div>
      <div className="profile__info">
        <div className="profile__avatar avatar"><img src="https://cdn.dribbble.com/users/3030608/screenshots/15223665/media/ecd75381aa7a354c78a4ed2aee65bd0f.jpg?compress=1&resize=400x300&vertical=top" alt="" /></div>
